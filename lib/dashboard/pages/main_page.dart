...
import 'package:firefly_app/dashboard/pages/memorycolors.dart';
import 'package:firefly_app/dashboard//pages/mycolors.dart';
        ...
        body: StaggeredGridView.count(
          ...
          children: <Widget>[
            _buildTile(
              ...
              onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => Mymemorycolors())),
            ),
            _buildTile(
              Padding(
                padding: const EdgeInsets.all(24.0),
              ...
              onTap: () => Navigator.of(context)
                  .push(MaterialPageRoute(builder: (_) => Mycolors())),
            ),
            _buildTile(
              Padding(
                padding: const EdgeInsets.all(24.0),
