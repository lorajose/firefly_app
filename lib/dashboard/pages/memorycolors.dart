...
import 'package:firefly_app/utils/image_picker_channel.dart';
import 'package:flutter/material.dart';

class Mymemorycolors extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new MyHomePage(title: 'Firefly'),
    );
  }
}
  ...
  Widget _buildButtons() {
    return new ConstrainedBox(
        ...
        child: new Row(
            ...
            children: <Widget>[
              _buildActionButton(new Key('retake'), 'Photos',
                      () => captureImage(ImageSource.photos)),
              _buildActionButton(new Key('upload'), 'Camera',
